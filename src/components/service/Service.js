  ...
  return (
    <div>
      ...
      <div className="flex items-center mt-32">
        ...
        <div className="w-[670px] h-[467px] bg-white rounded-l-xl absolute right-0 pl-16 pt-20">
            <h1 className="text-3xl text-[#100E34] font-bold">EVs For Everyone</h1>
            <p className="text-lg text-[#666872] w-96 mt-16">We Provide Many Of The Best Servises For You And You Will Get The Best Benefits Here</p>
            <button className="w-40 h-11 bg-[#100E34] text-white flex rounded-full text-sm font-semibold justify-between items-center px-5 mt-20">Read More <FaAngleRight /></button>
        </div>
      </div>
    </div>
  );
